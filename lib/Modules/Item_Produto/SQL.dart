...
abstract class SQLItemProduto {
  ...
  SELECT_ID_PRODUTO_IN_ITEM_PRODUTO = "SELECT $_ID_PRODUTO FROM $NAME_TABLE;",

  SELECT_ATIVO_ITEM_PRODUTO_BY_ID_PRODUTO = """SELECT ${SQLGeral.ATIVO} FROM 
  $NAME_TABLE WHERE $_ID_PRODUTO = %s;""",
